...
public final class Constants {
  ...
  // public static String AUTONOMOUS_PATH_FILENAME =
  // "/paths/2Balls1HangarFinalv2.csv";
  ...
  public static final double[] STEER_AND_ROTATE_THRESHOLDS = { STEER_GAINS_THRESHOLD, ROTATE_GAINS_THRESHOLD,
      ROTATE_VELOCITY_THRESHOLD };
  ...
  // Intake Constants
  public static final double ROLLER_RUN_SPEED = 0.4;
  public static final double[] INTAKE_GAINS = { 0, 0, 0 };
  public static final int INTAKE_OFFSET = 0;
  public static final double INTAKE_EXTEND = 0;
