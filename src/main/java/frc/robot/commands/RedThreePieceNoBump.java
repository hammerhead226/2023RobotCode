...
public class RedThreePieceNoBump extends SequentialCommandGroup {
  ...
  public RedThreePieceNoBump() {
    ...
    addCommands(
      ...
      new InstantCommand(()-> MotionOfTheOcean.Executor.loadRecordings("/paths/red_three_piece_nobumpV3.csv")),
      new InstantCommand(() -> MotionOfTheOcean.Executor.selectRecording("/paths/red_three_piece_nobumpV3.csv")),
      new InstantCommand(() -> DriveTrain.getInstance().reset()),
