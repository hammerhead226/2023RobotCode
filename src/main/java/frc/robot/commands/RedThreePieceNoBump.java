...
public class RedThreePieceNoBump extends SequentialCommandGroup {
  /** Creates a new TestAuto. */
  public RedThreePieceNoBump() {
    ...
    addCommands(
      ...
      new InstantCommand(()-> MotionOfTheOcean.Executor.loadRecordings("/paths/red_three_piece_nobumpV2.csv")),
      new InstantCommand(() -> MotionOfTheOcean.Executor.selectRecording("/paths/red_three_piece_nobumpV2.csv")),
      new InstantCommand(() -> DriveTrain.getInstance().reset()),
