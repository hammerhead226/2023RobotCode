...
// public class BlueThreePieceNoBump extends SequentialCommandGroup {
//   /** Creates a new TestAuto. */
//   public BlueThreePieceNoBump() {
...
//       new InstantCommand(()-> MotionOfTheOcean.Executor.loadRecordings("/paths/blue_three_piece_nobumpV3.csv")),
//       new InstantCommand(() -> MotionOfTheOcean.Executor.selectRecording("/paths/blue_three_piece_nobumpV3.csv")),
//       new InstantCommand(() -> DriveTrain.getInstance().reset()),
