...
public class BlueThreePieceNoBump extends SequentialCommandGroup {
  ...
  public BlueThreePieceNoBump() {
    ...
    addCommands(
      ...
      new InstantCommand(()-> MotionOfTheOcean.Executor.loadRecordings("/paths/blue_three_piece_nobumpV2.csv")),
      new InstantCommand(() -> MotionOfTheOcean.Executor.selectRecording("/paths/blue_three_piece_nobumpV2.csv")),
      new InstantCommand(() -> DriveTrain.getInstance().reset()),
