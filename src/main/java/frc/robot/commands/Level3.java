...
public class Level3 extends SequentialCommandGroup {
  ...
  public Level3() {
    ...
    addCommands(
      ...
      new InstantCommand(() -> Robot.m_robotContainer.manager.setElevatorTarget(Elevator.getHigh()), Robot.m_robotContainer.lock),
      new WaitUntilCommand(Robot.m_robotContainer.manager::armAndElevatorReached),
      new InstantCommand(() -> Robot.m_robotContainer.manager.setLinearSlideTarget(LinearSlide.getHigh()), Robot.m_robotContainer.lock)
    );
  }
}