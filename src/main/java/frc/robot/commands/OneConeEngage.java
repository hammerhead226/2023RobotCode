...
public class OneConeEngage extends SequentialCommandGroup {
  ...
  public OneConeEngage() {
    ...
    addCommands(
      ...
      new RunCommand(() -> DriveTrain.getInstance().toPose(new double[]{0, -113, 0}), DriveTrain.getInstance()).until(DriveTrain.getInstance()::atSetpoint),
      new RunCommand(() -> DriveTrain.getInstance().toPose(new double[]{0, -113, Math.PI}), DriveTrain.getInstance()).until(DriveTrain.getInstance()::atSetpoint)
