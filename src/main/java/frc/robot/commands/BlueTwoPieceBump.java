...
public class BlueTwoPieceBump extends SequentialCommandGroup {
  /** Creates a new TestAuto. */
  public BlueTwoPieceBump() {
    ...
    addCommands(
      ...
      new InstantCommand(()-> MotionOfTheOcean.Executor.loadRecordings("/paths/blue_two_piece_bump.csv")),
