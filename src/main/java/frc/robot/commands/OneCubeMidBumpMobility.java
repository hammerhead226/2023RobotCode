...
public class OneCubeMidBumpMobility extends SequentialCommandGroup {
  /** Creates a new OneCubeMidMobility. */
  public OneCubeMidBumpMobility() {
    ...
    addCommands(
      ...
      // do whatever here that strafes to the right
      // positive x goes legft
