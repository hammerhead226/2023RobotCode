...
public class RedThreePieceBump extends SequentialCommandGroup {
  /** Creates a new TestAuto. */
  public RedThreePieceBump() {
    ...
    addCommands(
      ...
      new InstantCommand(()-> MotionOfTheOcean.Executor.loadRecordings("/paths/red_three_piece_bump.csv")),
      new InstantCommand(() -> MotionOfTheOcean.Executor.selectRecording("/paths/red_three_piece_bump.csv")),
      new InstantCommand(() -> DriveTrain.getInstance().reset()),
